...
import org.qtitools.qti.node.test.flow.*;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

/**
 * modified version of qtitools DefaultItemFlow implementation
 *
 * @author Jiri Kajaba
 */
public class DefaultItemFlow implements ItemFlow {
    ...
    public AssessmentItemRef getCurrentItemRef() {
        logger.debug("Current item ref is {} in node {}.",
                (current != null) ? current.getItemRef().getIdentifier() : "NULL",
                (current != null) ? current.getIndex() : "NULL");
    ...
    public boolean hasPrevItemRef(boolean includeFinished) {
        ...
        logger.info("Previous item ref is {} in node {}.",
                (node != null) ? node.getItemRef().getIdentifier() : "NULL",
                (node != null) ? node.getIndex() : "NULL");
    ...
    public boolean hasNextItemRef(boolean includeFinished) {
        ...
        logger.info("Next item ref is {} in node {}.",
                (node != null) ? node.getItemRef().getIdentifier() : "NULL",
                (node != null) ? node.getIndex() : "NULL");
    ...
    public AssessmentItemRef getNextItemRef(boolean includeFinished) {
        ...
        if (current != null) {
            ...
            if (node == null || node.getItemRef().getParentTestPart() != current.getItemRef().getParentTestPart())
    ...
    public AssessmentItemRef getItemRefByIdentifier(String identifier, boolean forward) {
        ...
        logger.debug("DEBUG looking for Id "+ identifier + " , Matched Id" + itemRef);
        return itemRef;
    }
